...
output "backend_service_name" {
  description = "The name of the backend service for the demo API."
  value       = google_compute_backend_service.demo_backend.name
}

output "cloud_run_service_name" {
  description = "The name of the Cloud Run service."
  value       = google_cloud_run_v2_service.demo_api.name
}

output "cloud_run_service_uri" {
  description = "The URI of the Cloud Run service."
  value       = google_cloud_run_v2_service.demo_api.uri
}
